  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      if (_mediaFile != null) {
        ...
        mediaUrl = Supabase.instance.client.storage.from('media').getPublicUrl(path);
      }
      ...
      await Supabase.instance.client.from('reviews').insert({
        ...
        'image_url': mediaUrl, // Using the same field for video for simplicity in this demo
        'is_video': _isVideo,
      });

      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Review berjaya dihantar! Terima kasih!'), backgroundColor: Colors.green),
        );
                ...
                children: [
                  ClipRRect(
                    ...
                    child: _isVideo 
                      ...
                      : Image.file(_mediaFile!, height: 200, width: double.infinity, fit: BoxFit.cover),
                  ),
                  Positioned(
                    right: 8,
                    top: 8,
              ...
              children: [
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    icon: const HugeIcon(icon: HugeIcons.strokeRoundedImage01, color: Color(0xFFFF5722), size: 20),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    icon: const HugeIcon(icon: HugeIcons.strokeRoundedVideo01, color: Color(0xFFFF5722), size: 20),
