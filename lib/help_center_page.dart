                ...
                children: [
                  ...
                  Center(
                    child: TextButton(
                      ...
                      child: const Text("Still need help? Contact Us", style: TextStyle(color: Colors.blueAccent, fontWeight: FontWeight.w600)),
                    ),
                  ),
                ],
              ),
...
class ContactUsScreen extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildContactCard(
                    ...
                    "Chat to support", 
                    "We're here to help.", 
                    "Start a chat with Ipan",
                    onTap: () => _launchWhatsApp('601112769605'), // Assuming this is Ipan's number
                  ),
  ...
  Widget _buildContactCard(bool isDark, dynamic icon, String title, String subtitle, String action, {VoidCallback? onTap}) {
    return GestureDetector(
      onTap: onTap,
